    ...
    >
      ...
      >
        ...
        >
          ...
          >
            In this tab, your personal AI Fitness Assistant will help you devise a plan to improve your endurance in a specific activity you selected.<br />
            Scroll to the bottom of the plan in order to have the option to save it.<br />
            If you are on mobile, scroll down to see your endurance plan.
          </Typography>
        </Box>
      </Box>
      ...
      >
        ...
        >
          <Box sx={{ display: 'flex', p: 2, bgcolor: '#004d5612', my: 2, gap: 2, ml: -1, borderRadius: 2 }}>
            <Avatar sx={{ m1: '0' }}>
              <img src="Dumbell_Icon.png" alt="Running_Icon" width={"30px"} />
            </Avatar>
            <Box sx={{ flex: 1 }}>
              <Typography
                fontSize={"20px"}
